<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\news\news_cate_list.html";i:1567050636;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
							...
							<div class="panel-body">
								...
								<div class="ibox-content-del">
									...
									<div class="row">
										...
										<?php if($is_del == '1'): ?>
										<a href="<?php echo url('News/newsCateAdd'); ?>" class="btn btn-sm btn-primary">添加新闻</a>
										<?php endif; ?>
									</div>
...
<!--													<input type="checkbox" class="i-checks checkbox" name="input" value="<?php echo $vo['id']; ?>">-->
												...
												<td><?php echo $vo['en_class_name']; ?></td>
												<td>
													<a href="<?php echo url('News/newsCateAdd', ['news_id' => $vo['id']]); ?>" class="btn btn-xs btn-warning">编辑</a>
													<?php if($is_del == '1'): ?>
...
<script type="text/javascript">
	...
	$('.btn_del').click(function () {
		...
		dialog.showTips('确定要删除吗？', "firm", function(){
			...
			$.ajax({
				url: "<?php echo url('News/delNewsCate'); ?>",
				type: "post",
				dataType: "json",
				data: {
					id: id,
