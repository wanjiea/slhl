<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\contact\feedback.html";i:1567050636;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
										...
										<form method="get" action="">
											...
											<div class="col-sm-3">
												<div class="input-group">
													<input type="text" name="keyword" placeholder="姓名|手机号" class="input-sm form-control" value="<?php echo $keyword; ?>">
									...
									<div class="table-responsive">
										<table class="table table-hover products_table">
											...
											<tr >
												...
												<td>
													<a href="http://www.testslhl.com/admin/<?php echo $controller_name; ?>/<?php echo $a_action_name; ?>Detail/id/<?php echo $vo['id']; ?>" class="btn btn-xs btn-warning">编辑</a>
...
<script type="text/javascript">
	...
	$('.btn_del').click(function () {
		...
		dialog.showTips('确定要删除吗？', "firm", function(){
			...
			$.ajax({
				url: "<?php echo url('Contact/delFeedback'); ?>",
				type: "post",
				dataType: "json",
				data: {
					id: id,
