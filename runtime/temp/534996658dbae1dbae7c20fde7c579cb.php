<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\cases\need_list.html";i:1568943880;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<!--										<a href="<?php echo url('cases/needAdd'); ?>" class="btn btn-sm btn-primary">添加要求</a>-->
									</div>
									...
									<div class="table-responsive">
										<table class="table table-hover products_table">
											...
											<tr >
												...
												<td>
													<a href="<?php echo url('cases/needAdd', ['need_id' => $vo['id']]); ?>" class="btn btn-xs btn-warning">编辑</a>
...
<script type="text/javascript">
	...
	$('.btn_change').click(function () {
		...
		var need_cate_id = $('#need_cate_id').val();
		dialog.showTips('确定转移吗？', "firm", function(){

			$.ajax({
				url: "<?php echo url('need/needChange'); ?>",
				type: "post",
				dataType: "json",
				data: {
					id: id,
					need_cate_id: need_cate_id,
				}
			}).done(function (res) {
				if (res.status == 1) {
	...
	function status (id,item, obj) {
		...
		$.ajax({
			type:"POST",
			url: 'http://www.testslhl.com/admin/need/needStatus',
