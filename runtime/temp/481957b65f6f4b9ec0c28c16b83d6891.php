<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\cases\cases_add.html";i:1568896230;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php if(empty($cache) || (($cache instanceof \think\Collection || $cache instanceof \think\Paginator ) && $cache->isEmpty())): ?>添加<?php else: ?>修改<?php endif; ?>案例</h5>
                </div>
                    ...
                    <form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b
                                    style="color:red;">*</b>案例分类：</label>

                            <div class="col-sm-9">
                                <select name="cate_id" style="width:190px;height:35px"
                                        class="manager_cate_id">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $cache['cate_id']): ?>selected<?php endif; ?>><?php echo $vo['class_name']; ?></option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>场所：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="address" style="width:60%" value="<?php echo $cache['address']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>订单数：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="order_num" style="width:60%" value="<?php echo $cache['order_num']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>收益数：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="income" style="width:60%" value="<?php echo $cache['income']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>回本周期：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="cycle" style="width:60%" value="<?php echo $cache['cycle']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>年回报率：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="return" style="width:60%" value="<?php echo $cache['return']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script>
    ...
    $('.save').click(function(){
        ...
        $.post("<?php echo url('cases/casesHandle'); ?>",post, function(data){
            if(data.status){

                dialog.showTips(data.msg,"", "<?php echo url('cases/casesList'); ?>");
            }else{
                alert(data.msg);
            }
        }, "json");
