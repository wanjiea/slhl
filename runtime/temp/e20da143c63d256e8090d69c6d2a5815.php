<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\product\product_list.html";i:1569044299;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
							...
							<div class="panel-body">
								...
								<div class="ibox-content-del">
									...
									<div class="row">
										...
										<a href="<?php echo url('product/productAdd'); ?>" class="btn btn-sm btn-primary">添加产品</a>
									</div>
...
<!--												<td><?php echo $vo['add_time']; ?></td>-->
												...
												<td>
													<a href="<?php echo url('product/productAdd', ['product_id' => $vo['id']]); ?>" class="btn btn-xs btn-warning">编辑</a>
												    <a href="javaScript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-warning updown" data-num="-1" data-class_id="<?php echo $vo['id']; ?>" title="上移">上移</a>
													<a href="javaScript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-warning updown" data-num="1" data-class_id="<?php echo $vo['id']; ?>"  title="下移">下移</a>
...
<script type="text/javascript">
	...
	$('.btn_change').click(function () {
		...
		dialog.showTips('确定转移吗？', "firm", function(){
			...
			$.ajax({
				url: "<?php echo url('product/productChange'); ?>",
				type: "post",
				dataType: "json",
				data: {
					id: id,
	...
	$(".updown").click(function() {
		...
		$.ajax({
			url: "http://www.testslhl.com/admin/product/productUpDown",
			type: "post",
			dataType: "json",
			data: post,
		}).done(function (res) {
	...
	$('.btn_del').click(function () {
		...
		dialog.showTips('确定要删除吗？', "firm", function(){
			...
			$.ajax({
				url: "<?php echo url('product/delproduct'); ?>",
				type: "post",
				dataType: "json",
				data: {
					id: id,
	...
	function status (id,item, obj) {
		...
		$.ajax({
			type:"POST",
			url: 'http://www.testslhl.com/admin/product/productStatus',
