<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\setting\index.html";i:1567050632;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>网站标题：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="title" style="width:32%" value="<?php echo $setting_info['title']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>网站版权：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control copyright" name="copyright" style="width:80%" value="<?php echo $setting_info['copyright']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>备案号：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control records" name="records" style="width:32%" value="<?php echo $setting_info['records']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style='color:red;'>*</b>上传网站logo：</label>
                            <div class="col-sm-9">
                                <div class="col-sm-9">
                                    <div class="info_head">
                                        <input type="file"
                                        ...
                                        <div class="xuanze_showimge mgr10" data-nums='15' style="position:relative;" >
                                            <?php if(!(empty($setting_info['header_logo']) || (($setting_info['header_logo'] instanceof \think\Collection || $setting_info['header_logo'] instanceof \think\Paginator ) && $setting_info['header_logo']->isEmpty()))): ?>
                                            <div style='float:left;position:relative;'>
                                                <img src="<?php echo $setting_info['header_logo']; ?>"  class="mgr10 mgt10 ">
                                                <input type="hidden" name="header_logo" class="header_logo" value="<?php echo $setting_info['header_logo']; ?>">
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<script>
    $('.save').click(function(){
        ...
        $.post("<?php echo url('Setting/index'); ?>",post, function(data){
            if(data.status){
