<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\news\news_add.html";i:1568890961;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>新闻分类：</label>

                            <div class="col-sm-9">
                                <select name="cate_id" style="width:190px;height:35px" class="manager_cate_id">
...
<!--                        <div class="hr-line-dashed"></div>-->
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>发布日期：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control add_time" name="add_time" style="width:35%"  id="start" value="<?php echo $cache['add_time']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>详情：</label>-->
<!--                            <div class="col-sm-9">-->
<!--                                <textarea  id="content" name="content" maxlength="500" cols="100" rows="8" style="text-align: left;resize:none"><?php echo $cache['content']; ?></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="hr-line-dashed"></div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>详情英：</label>-->
<!--                            <div class="col-sm-9">-->
<!--                                <textarea  id="en_content" name="en_content" maxlength="500" cols="100" rows="8" style="text-align: left;resize:none"><?php echo $cache['en_content']; ?></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="hr-line-dashed"></div>-->
...
<script>
   ...
   $('.save').click(function(){
       ...
       $.post("<?php echo url('News/newsHandle'); ?>",post, function(data){
           if(data.status){
               dialog.showTips(data.msg,"","<?php echo url('News/newsList'); ?>");
           }else{
               alert(data.msg);
           }
       }, "json");
