<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\banner\banner_add.html";i:1569064310;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php if(empty($cache) || (($cache instanceof \think\Collection || $cache instanceof \think\Paginator ) && $cache->isEmpty())): ?>添加<?php else: ?>修改<?php endif; ?>Banner信息</h5>
                </div>
                <div class="ibox-content">
                    <form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>banner分类：</label>

                            <div class="col-sm-9">
                                <select name="class_id" style="width:190px;height:35px" class="manager_cate_id" >
                                    <option value="">-请选择分类-</option>
                                    <?php if(is_array($cate_list) || $cate_list instanceof \think\Collection || $cate_list instanceof \think\Paginator): if( count($cate_list)==0 ) : echo "" ;else: foreach($cate_list as $k=>$vo): ?>
                                    <option value="<?php echo $k; ?>" <?php if($k == $cache['class_id']): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control en_title" name="sub_title" style="width:60%" value="<?php echo $cache['sub_title']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<!-- 						<div class="form-group">-->
<!--                            <label class="col-sm-2 control-label"><b style='color:red;'>*</b>上传图片（手机）：</label>-->
<!--                            <div class="col-sm-9">-->
<!--                                <div class="col-sm-9">-->
<!--                                    <div class="info_heads">-->
<!--                                        <input type="file"-->
...
<!--                                        <img  class='goods_logo' src="http://www.testslhl.com/static/admin/images/addimg.png" />-->
<!--                                        <div class="xuanze_showimge mgr10" data-nums='15' style="position:relative;" >-->
<!--                                            <?php if(!(empty($cache['phone_pic']) || (($cache['phone_pic'] instanceof \think\Collection || $cache['phone_pic'] instanceof \think\Paginator ) && $cache['phone_pic']->isEmpty()))): ?>-->
<!--                                            <div style='float:left;position:relative;'>-->
<!--                                                <img src="<?php echo $cache['phone_pic']; ?>" class="mgr10 mgt10 ">-->
<!--                                                <input type="hidden" name="phone_pic" class="phone_pic" value="<?php echo $cache['phone_pic']; ?>">-->
<!--                                            </div>-->
<!--                                            <?php endif; ?>-->
<!--                                        </div>-->
<!--                                    </div>-->
...
<script>
   ...
   $('.save').click(function(){
       ...
       $.post("<?php echo url('Banner/bannerHandle'); ?>",post, function(data){
           if(data.status){
                    url = "<?php echo url('Banner/bannerList'); ?>";
               dialog.showTips(data.msg,"",url);
           }else{
               alert(data.msg);
           }
       }, "json");
