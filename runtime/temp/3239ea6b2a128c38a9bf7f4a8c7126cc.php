<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\contact\contact.html";i:1568878572;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
				...
				<div class="ibox-content">
					<form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control en_title" name="tel" style="width:60%" value="<?php echo $cache['tel']; ?>">
							</div>
						</div>
						<div class="hr-line-dashed"></div>
...
<script>
	...
	$('.save').click(function(){
		...
		$.post("<?php echo url('Contact/contactHandle'); ?>",post, function(data){
			if(data.status){
