<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\banner\banner_list.html";i:1569064653;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<!--										<a href="<?php echo url('Banner/bannerAdd'); ?>" class="btn btn-sm btn-primary">添加Banner</a>-->
									...
									<div class="table-responsive">
										<table class="table table-hover products_table">
											...
											<tr >
												...
												<td><?php echo $cate_list[$vo['class_id']]; ?></td>
												<td><a href="<?php echo $vo['pic']; ?>" target="_blank"><img src="<?php echo $vo['pic']; ?>" height="60"/></a></td>
												<td>
													<a href="<?php echo url('Banner/bannerAdd', ['banner_id' => $vo['id']]); ?>" class="btn btn-xs btn-warning">编辑</a>
													<a href="javaScript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-warning updown" data-num="-1" data-class_id="" title="上移">上移</a>
													<a href="javaScript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-warning updown" data-num="1" data-class_id=""  title="下移">下移</a>
...
<script type="text/javascript">
	...
	$('.btn_del').click(function () {
		...
		dialog.showTips('确定要删除吗？', "firm", function(){
			...
			$.ajax({
				url: "<?php echo url('Banner/delBanner'); ?>",
				type: "post",
				dataType: "json",
				data: {
					id: id,
	...
	$(".updown").click(function() {
		...
		$.ajax({
			url: "http://www.testslhl.com/admin/Banner/upDown",
			type: "post",
			dataType: "json",
			data: post,
		}).done(function (res) {
