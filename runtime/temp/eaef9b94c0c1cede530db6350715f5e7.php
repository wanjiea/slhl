<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\join\income_add.html";i:1568877109;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php if(empty($cache) || (($cache instanceof \think\Collection || $cache instanceof \think\Paginator ) && $cache->isEmpty())): ?>添加<?php else: ?>修改<?php endif; ?>收益分配信息</h5>
                </div>
                <div class="ibox-content">
                    <form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="name" style="width:60%" value="<?php echo $cache['name']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>单价：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="price" style="width:60%" value="<?php echo $cache['price']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>计价单位：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="unit" style="width:60%" value="<?php echo $cache['unit']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>利润分配：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="profit" style="width:60%" value="<?php echo $cache['profit']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>预期单日量：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="amount" style="width:60%" value="<?php echo $cache['amount']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>日收益：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="income_day" style="width:60%" value="<?php echo $cache['income_day']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><b style="color:red;">*</b>年收益：</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control title" name="income_year" style="width:60%" value="<?php echo $cache['income_year']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<input type="file"  accept="image/jpg,image/jpeg,image/png" name="upload_pic" class="xuanze_hidden xuanze_hidden1" style="display: none">
...
<script>
   ...
   $('.save').click(function(){
       ...
       $.post("<?php echo url('join/incomeHandle'); ?>",post, function(data){
           if(data.status){
               dialog.showTips(data.msg,"","<?php echo url('join/income'); ?>");
           }else{
               alert(data.msg);
           }
       }, "json");
