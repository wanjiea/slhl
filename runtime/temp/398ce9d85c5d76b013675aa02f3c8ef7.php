<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"E:\phpstudy8\phpstudy_pro\WWW\slhl\public/../application/admin\view\cases\need_add.html";i:1568943769;s:72:"E:\phpstudy8\phpstudy_pro\WWW\slhl\application\admin\view\Base\base.html";i:1567050636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form enctype="multipart/form-data" method="post" id="add_step" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control name" name="name" style="width:60%" value="<?php echo $cache['name']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea  name="content" id="content"><?php echo $cache['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control phone" name="phone" style="width:60%" value="<?php echo $cache['phone']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script>
    ...
    $('.save').click(function(){
        ...
        $.post("<?php echo url('cases/needHandle'); ?>",post, function(data){
            if(data.status){

                dialog.showTips(data.msg,"", "<?php echo url('cases/needList'); ?>");
            }else{
                alert(data.msg);
            }
        }, "json");
