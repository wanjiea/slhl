(function( $ ){
    ...
    // 当domReady的时候开始初始化
    $(function() {
		var upload_parth=$("#upode_parth").val();
        ...
        uploader = WebUploader.create({
			...
			accept: {
            //     title: 'Images',
                extensions: 'mp4,zip,mp3,mov,avi,wmv,V0B,RMVB,FLV,3GP,MKV',
        ...
        function addFile( file ) {
			...
			uploader.on( 'uploadSuccess', function( file, res ) {
				console.dir(res);//这里可以得到上传后的文件路径 
				var exts=res.exts;
                ...
                var name=res.name;
					$.ajax({
						url:"/Store/Video/getFile1",
						data:{parth:parth,exts:exts,chunks:chunks,save_name:save_name,temp:temp,name:name},
						type:'post',
						datatype:'josn',
					}).done(function(g){
						console.dir(g);
