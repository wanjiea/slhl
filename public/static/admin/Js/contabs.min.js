getTabs()
function getTabs() {
	var J_mainContent=$(".J_mainContent").length>0 ? $(".J_mainContent") : $('.J_mainContent', window.parent.document);
	var J_menuTabs=$(".J_menuTabs").length>0 ? $(".J_menuTabs") : $('.J_menuTabs', window.parent.document);
	...
	function c() {
		var o = $(this).attr("href"),
			...
			l = $.trim($(this).text()),
			k = true;
		if($(this).find(".J_menuItem_tit").length>0){
			l=$(this).find(".J_menuItem_tit").text();
		}
		if(o == undefined || $.trim(o).length == 0) {
			return false
		}
		J_menuTabs.find(".J_menuTab").each(function() {
			if($(this).data("id") == o) {
		...
		if(k) {
			...
			J_menuTabs.find(".J_menuTab").removeClass("active");
			var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
			J_mainContent.find("iframe.J_iframe").hide().parents(".J_mainContent").append(n);
			J_menuTabs.find(".page-tabs-content").append(p);
			g($(".J_menuTab.active"))
		}
		return false
	}
