...
// ==========================================================================
// Credits: paypal.github.io/accessible-html5-video-player/
// ==========================================================================
...
(function (api) {
    ...
    // Credits: diveintohtml5.info/everything.html
    // Related: www.leanbackplayer.com/test/h5mt.html
    ...
    // Unwrap an element
    // plainjs.com/javascript/manipulation/unwrap-a-dom-element-35/
    ...
    function Plyr(container) {
        ...
        function _seekManualCaptions(time) {
            ...
            // twitter.com/Sam_Potts/status/573715746506731521
        ...
        function _setupYouTube(id) {
            ...
            if (typeof YT === 'object') {
                ...
                // Load the API
                _injectScript('www.youtube.com/iframe_api');
        ...
        function _setupCaptions() {
            if (player.type === 'video') {
                ...
                // If caption file exists, process captions
                    ...
                    // Native support required - caniuse.com/webvtt
        ...
        // stackoverflow.com/questions/12528049/if-a-dom-element-is-removed-are-its-listeners-also-removed-from-memory
        function _destroy() {
            ...
            // stackoverflow.com/questions/19469881/javascript-remove-all-event-listeners-of-specific-type
